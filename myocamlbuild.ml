(* OASIS_START *)
(* DO NOT EDIT (digest: 8715d29ecdc87c589a059a32c520818f) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ("decompress", ["lib"], []);
          ("bindings", ["bindings"], []);
          ("abindings", ["bindings/apply"], [])
       ];
     lib_c = [];
     flags =
       [
          (["oasis_library_decompress_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-inline"; A "100"])]);
          (["oasis_library_decompress_native"; "ocaml"; "ocamldep"; "native"],
            [(OASISExpr.EBool true, S [A "-inline"; A "100"])]);
          (["oasis_library_decompress_native"; "ocaml"; "compile"; "native"],
            [(OASISExpr.EBool true, S [A "-inline"; A "100"])]);
          (["oasis_executable_dpipe_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-inline"; A "100"])]);
          (["oasis_executable_dpipe_native"; "ocaml"; "ocamldep"; "native"],
            [(OASISExpr.EBool true, S [A "-inline"; A "100"])]);
          (["oasis_executable_dpipe_native"; "ocaml"; "compile"; "native"],
            [(OASISExpr.EBool true, S [A "-inline"; A "100"])]);
          (["oasis_executable_dcpr_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-inline"; A "100"])]);
          (["oasis_executable_dcpr_native"; "ocaml"; "ocamldep"; "native"],
            [(OASISExpr.EBool true, S [A "-inline"; A "100"])]);
          (["oasis_executable_dcpr_native"; "ocaml"; "compile"; "native"],
            [(OASISExpr.EBool true, S [A "-inline"; A "100"])]);
          (["oasis_executable_rev_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-inline"; A "100"])]);
          (["oasis_executable_rev_native"; "ocaml"; "ocamldep"; "native"],
            [(OASISExpr.EBool true, S [A "-inline"; A "100"])]);
          (["oasis_executable_rev_native"; "ocaml"; "compile"; "native"],
            [(OASISExpr.EBool true, S [A "-inline"; A "100"])])
       ];
     includes =
       [
