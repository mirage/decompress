...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2c30f2942b8341e53b16d8750f60f7e7) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/dinosaure/Decompress";
          synopsis = "Inflate and Deflate Zlib";
          description = Some [OASISText.Para "Pure OCaml Library for Zlib"];
          categories = [];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Unix environment";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "cmdliner package";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Example of use Decompress";
                      flag_default =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "unix",
                                OASISExpr.EFlag "cmdliner"),
                             true)
                        ]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Trace all compute of decompress";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Produce a shared library of decompress";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "camlzip package";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_nativeopt =
                        [(OASISExpr.EBool true, ["-inline"; "100"])]
                   },
                   {
                      lib_modules =
                        [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ppx_debug.ml"});
               Doc
                 ({
                     cs_name = "decompress";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "dpipe.ml"});
               Executable
                 ({
                     cs_name = "dcpr";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "dcpr.ml"});
               Executable
                 ({
                     cs_name = "rev";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "rev.ml"});
               Object
                 ({
                     cs_name = "bindings";
                     cs_data = PropList.Data.create ();
                   ...
                   {obj_modules = ["Bindings"]; obj_findlib_fullname = None});
               Object
                 ({
                     cs_name = "abindings";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "bindings/apply";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "bindings"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {obj_modules = ["Abindings"]; obj_findlib_fullname = None});
               Executable
                 ({
                     cs_name = "generate";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "generate.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/oklm-wsh/Decompress.git";
                      src_repo_browser =
                        Some "https://github.com/oklm-wsh/Decompress";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "decompress_test.ml"});
               Test
                 ({
                     cs_name = "test_decompress";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "test_decompress"
                        ]
                   })
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\229\142+\138[\003V\031_J\130'\228\143\241'";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
