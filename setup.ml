...
(* OASIS_START *)
(* DO NOT EDIT (digest: fabfa1001818c411e3887d5779c59119) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Adler32"; "Window"; "Inflate"];
                      lib_pack = false;
                      lib_internal_modules = ["Huffman"; "Common"];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "decompress"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/dinosaure/Decompress.git";
                      src_repo_browser =
                        Some "https://github.com/dinosaure/Decompress";
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "|\236\189\001j\248\158\211\152\247\143\192\127'\006\204";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
