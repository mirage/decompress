Test reverse bindings
  ...
  > }
  > EOF
  $ export LDFLAGS=$(ocamlc -config | grep "^native_c_libraries: " | cut -d':' -f2-)
  $ cc -o a.out main.c -I$(ocamlopt -where) -L../../bindings/stubs -I../../bindings/stubs -ldecompress $LDFLAGS 2> /dev/null
  $ ./a.out
  Hello World!
